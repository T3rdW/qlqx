...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    console.log(`------------- ??${jzreadurlArr.length}个账??-------------\n`)
     ...
     await benefit()
       ...
       //await info()
        ...
        if (jzreadurls[item]) {
          ...
          console.log(`??${jzreadurlArr.length}个cookie`)
...
'Accept-Encoding':' gzip, deflate',
 ...
 return new Promise((resolve) => {
    ...
    let nm = {
     ...
     body:  `device=iPhone 8 Plus&id=&os=14.4&source=article&token=`+token,
            headers:{
'Host': 'api.st615.com',
'Content-Type':' application/x-www-form-urlencoded; charset=utf-8',
...
'Accept-Language': 'zh-Hans-CN;q=1.0, zh-Hant-HK;q=0.9, zh-Hant-CN;q=0.8',
 ...
 return new Promise((resolve) => {
    ...
    let nm = {
     ...
     //body:  `device=iPhone 8 Plus&id=${id}&os=14.4&source=article&token=`+token,
             headers:{
'Host': 'api.st615.com',
'Content-Type':' application/x-www-form-urlencoded; charset=utf-8',
